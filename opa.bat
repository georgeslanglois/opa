...
set "url=http://10.200.35.7/portal_pgs/ServidoresIP-Domain-OS.asp"
...
echo "winscp_local=T:\DOP\SDO\GDC\CDPL\SPOE - Planejamento Open\2. APLICATIVOS COMUNS\WinSCP\WinSCP.exe"
echo.
echo \\ SUBSTITUA O CAMINHO ABAIXO PELO LOCAL DO SEU EXECUTÁVEL DO MOBA OU MATENHA O PADRÃO
echo "moba_local=T:\DOP\SDO\GDC\CDPL\SPOE - Planejamento Open\2. APLICATIVOS COMUNS\MobaXterm\MobaXterm_Personal_21.4.exe"
echo.
